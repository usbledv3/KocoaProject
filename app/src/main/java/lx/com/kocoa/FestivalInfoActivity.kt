...
class FestivalInfoActivity : AppCompatActivity(), OnMapReadyCallback {
    lateinit var binding: ActivityFestivalInfoBinding
    var mapx : String? = null
    var mapy : String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityFestivalInfoBinding.inflate(layoutInflater)
...
//        }
        ...
        SelectedDoData.selectedItem?.apply {
            binding.fesImageView.setImageResource(this.doImage)
            binding.fesDateView.text = "기간 : ${this.doDate}"
            binding.fesPlaceView.text = "장소 : ${this.doPlace}"
        ...
        binding.reviewbtn.setOnClickListener {
            startActivity(Intent(this@FestivalInfoActivity,ReviewActivity::class.java))
        }
        binding.minigamebtn.setOnClickListener {
            startActivity(Intent(this@FestivalInfoActivity,MiniGameActivity::class.java))
        }
        binding.rtbtn.setOnClickListener {
            startActivity(Intent(this@FestivalInfoActivity,RouteActivity::class.java))
        }
    }
